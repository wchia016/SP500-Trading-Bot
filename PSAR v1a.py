# -*- coding: utf-8 -*-
"""
Created on Fri May 15 17:57:20 2020
...
#Experiment on SnP for trade vs buy-hold strategy
...
V = yf.download('V', start=datetime.date.today()-datetime.timedelta(365),end=datetime.date.today())

'Current Issue: Error of a few dollars cause lag in switch by 1 day'
...
test2 = psar(V,0.02,0.2,0.02)
graph = test2[['Adj Close','PSAR']]
graph.plot()
